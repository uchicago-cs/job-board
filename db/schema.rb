...
ActiveRecord::Schema.define(:version => 20130107041243) do
  ...
  create_table "employers", :force => true do |t|
    ...
    t.boolean  "alert_on_approve",        :default => true
    t.boolean  "alert_on_reject",         :default => true
    t.boolean  "alert_on_changes_needed", :default => true
